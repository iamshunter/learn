...
0.0002default:defaultZ17-268
J
>Phase 1.1.1 Mandatory Logic Optimization | Checksum: e22fa77e
*common
Œ

%s
*constraints2u
aTime (s): cpu = 00:00:00.02 ; elapsed = 00:00:00.03 . Memory (MB): peak = 1491.574 ; gain = 0.0042default:default
ƒ

Phase %s%s
101*constraints2
...
U
IPhase 1.1.2 Build Super Logic Region (SLR) Database | Checksum: e22fa77e
*common
Œ

%s
...
=
1Phase 1.1.3 Add Constraints | Checksum: e22fa77e
*common
Œ

%s
...
;
/Phase 1.1.4 Build Macros | Checksum: 161c78995
*common
Œ

%s
*constraints2u
aTime (s): cpu = 00:00:00.07 ; elapsed = 00:00:00.08 . Memory (MB): peak = 1491.574 ; gain = 0.0042default:default
|

Phase %s%s
101*constraints2
...
O
CPhase 1.1.5 Implementation Feasibility check | Checksum: 161c78995
*common
Œ

%s
*constraints2u
aTime (s): cpu = 00:00:00.08 ; elapsed = 00:00:00.10 . Memory (MB): peak = 1491.574 ; gain = 0.0042default:default
k

Phase %s%s
101*constraints2
...
>
2Phase 1.1.6 Pre-Place Cells | Checksum: 161c78995
*common
Œ

%s
*constraints2u
aTime (s): cpu = 00:00:00.09 ; elapsed = 00:00:00.11 . Memory (MB): peak = 1491.574 ; gain = 0.0042default:default
Ž

Phase %s%s
101*constraints2
...
a
UPhase 1.1.7 IO Placement/ Clock Placement/ Build Placer Device | Checksum: 16e8de6ea
*common
Š

%s
*constraints2s
_Time (s): cpu = 00:00:00.39 ; elapsed = 00:00:01 . Memory (MB): peak = 1515.582 ; gain = 24.0122default:default
v

Phase %s%s
101*constraints2
...
C
7Phase 1.1.8.1.1 Build Clock Data | Checksum: 21e7608b5
*common
Š

%s
*constraints2s
_Time (s): cpu = 00:00:00.44 ; elapsed = 00:00:01 . Memory (MB): peak = 1515.582 ; gain = 24.0122default:default
B
6Phase 1.1.8.1 Place Init Design | Checksum: 2304b0684
*common
Š

%s
*constraints2s
_Time (s): cpu = 00:00:00.45 ; elapsed = 00:00:01 . Memory (MB): peak = 1515.582 ; gain = 24.0122default:default
I
=Phase 1.1.8 Build Placer Netlist Model | Checksum: 2304b0684
*common
Š

%s
...
Q
EPhase 1.1.9.1 Constrain Global/Regional Clocks | Checksum: 2304b0684
*common
Š

%s
...
_Time (s): cpu = 00:00:00.45 ; elapsed = 00:00:01 . Memory (MB): peak = 1515.582 ; gain = 24.0122default:default
F
:Phase 1.1.9 Constrain Clocks/Macros | Checksum: 2304b0684
*common
Š

%s
...
_Time (s): cpu = 00:00:00.45 ; elapsed = 00:00:01 . Memory (MB): peak = 1515.582 ; gain = 24.0122default:default
G
;Phase 1.1 Placer Initialization Core | Checksum: 2304b0684
*common
Š

%s
...
_Time (s): cpu = 00:00:00.45 ; elapsed = 00:00:01 . Memory (MB): peak = 1515.582 ; gain = 24.0122default:default
@
4Phase 1 Placer Initialization | Checksum: 2304b0684
*common
Š

%s
...
9
-Phase 2.1 Run Budgeter | Checksum: 223dc21fe
*common
Š

%s
*constraints2s
_Time (s): cpu = 00:00:00.63 ; elapsed = 00:00:01 . Memory (MB): peak = 1516.582 ; gain = 25.0122default:default
;
/Phase 2 Global Placement | Checksum: 1736f837f
*common
Š

%s
*constraints2s
_Time (s): cpu = 00:00:00.96 ; elapsed = 00:00:01 . Memory (MB): peak = 1524.586 ; gain = 33.0162default:default
h

Phase %s%s
101*constraints2
...
G
;Phase 3.1 Commit Multi Column Macros | Checksum: 1736f837f
*common
Š

%s
*constraints2s
_Time (s): cpu = 00:00:00.97 ; elapsed = 00:00:01 . Memory (MB): peak = 1524.586 ; gain = 33.0162default:default
v

Phase %s%s
101*constraints2
...
I
=Phase 3.2 Commit Most Macros & LUTRAMs | Checksum: 1a1467460
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:01 ; elapsed = 00:00:01 . Memory (MB): peak = 1534.602 ; gain = 43.0312default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 3.3 Area Swap Optimization | Checksum: 1658a6caa
*common
‡

%s
...
B
6Phase 3.4 Timing Path Optimizer | Checksum: 18d80413d
*common
‡

%s
...
M
APhase 3.5 Commit Small Macros & Core Logic | Checksum: 20cc3fab6
*common
‡

%s
*constraints2p
\Time (s): cpu = 00:00:01 ; elapsed = 00:00:01 . Memory (MB): peak = 1552.609 ; gain = 61.0392default:default
l

Phase %s%s
101*constraints2
...
?
3Phase 3.6 Re-assign LUT pins | Checksum: 20cc3fab6
*common
‡

%s
...
\Time (s): cpu = 00:00:01 ; elapsed = 00:00:01 . Memory (MB): peak = 1552.609 ; gain = 61.0392default:default
;
/Phase 3 Detail Placement | Checksum: 20cc3fab6
*common
‡

%s
...
@
4Phase 4.1 PCOPT Shape updates | Checksum: 20cc3fab6
*common
‡

%s
...
Q
EPhase 4.2.1 Post Placement Timing Optimization | Checksum: 2d56d189a
*common
‡

%s
...
\Time (s): cpu = 00:00:01 ; elapsed = 00:00:01 . Memory (MB): peak = 1552.609 ; gain = 61.0392default:default
H
<Phase 4.2 Post Placement Optimization | Checksum: 2d56d189a
*common
‡

%s
...
C
7Phase 4.3 Post Placement Cleanup | Checksum: 2d56d189a
*common
‡

%s
...
C
7Phase 4.4.1 Congestion Reporting | Checksum: 2d56d189a
*common
‡

%s
...
A
5Phase 4.4.2 updateTiming final | Checksum: 2cba96942
*common
‡

%s
...
C
7Phase 4.4.3 Dump Critical Paths  | Checksum: 2cba96942
*common
‡

%s
...
:
.Phase 4.4.4 Restore STA | Checksum: 2cba96942
*common
‡

%s
...
>
2Phase 4.4.5 Print Final WNS | Checksum: 2cba96942
*common
‡

%s
...
\Time (s): cpu = 00:00:01 ; elapsed = 00:00:01 . Memory (MB): peak = 1552.609 ; gain = 61.0392default:default
=
1Phase 4.4 Placer Reporting | Checksum: 2cba96942
*common
‡

%s
...
D
8Phase 4.5 Final Placement Cleanup | Checksum: 2e18f962f
*common
‡

%s
...
\Time (s): cpu = 00:00:01 ; elapsed = 00:00:01 . Memory (MB): peak = 1552.609 ; gain = 61.0392default:default
S
GPhase 4 Post Placement Optimization and Clean-Up | Checksum: 2e18f962f
*common
‡

%s
...
\Time (s): cpu = 00:00:01 ; elapsed = 00:00:01 . Memory (MB): peak = 1552.609 ; gain = 61.0392default:default
5
)Ending Placer Task | Checksum: 2092f83de
*common
‡

%s
...
‚
vreport_utilization: Time (s): cpu = 00:00:00.02 ; elapsed = 00:00:00.07 . Memory (MB): peak = 1560.625 ; gain = 0.000
*common
m
